  ...
  return (
    <HomeContainer>
      ...
      <div className="bg-white px-[10%] grid grid-cols-12 py-24 gap-20">
        <h1 className="mx-auto col-span-full text-black-gray font-bold text-4xl">
          About Us
        </h1>
        ...
        <div className="col-span-7 lg:col-span-4">
          <Card
            image={"/cole_photo.png"}
            imageAlt={"Photo of Cole Drake"}
            name={"Cole Drake"}
            description={
              "Hello, My name is Cole Drake and I am a second year studying Electrical Computer Engineering at Carnegie Mellon University."
            }
            linkedin={"https://www.linkedin.com"}
            email={"coled@andrew.cmu.edu"}
          ></Card>
        </div>
      </div>
    </HomeContainer>
