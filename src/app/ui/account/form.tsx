...
const form = ({ session }: { session: Session | null }) => {
  ...
  return (
    <>
      ...
      <form className="flex flex-col gap-4 w-[33vw]" onSubmit={handleSubmit}>
        ...
        <label className="form-control w-full">
          <div className="label">
            <span className="label-text text-black-gray">Current Password</span>
          </div>
          <input
            type="text"
        ...
        <label className="form-control w-full">
          <div className="label">
            <span className="label-text text-black-gray">Confirm Password</span>
          </div>
          <input
            type="text"
            name="password2"
